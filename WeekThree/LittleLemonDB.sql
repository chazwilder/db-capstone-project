...
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`Bookings` (
  ...
  `TimeSlot` TIME NOT NULL DEFAULT '17:00',
  `NumberOfGuests` INT NOT NULL DEFAULT 1,
  `CustomerID` INT NOT NULL DEFAULT 1,
  `EmployeeID` INT NULL,
  `BookingType` INT NOT NULL DEFAULT 2,
  `TableID` INT NULL,
...
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`Orders` (
  ...
  INDEX `TableRef_idx` (`TableNumber` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `LittleLemonDB`.`OrdersView` (`idOrders` INT, `ItemQuantity` INT, `BillAmount` INT);
...
START TRANSACTION;
USE `LittleLemonDB`;
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (1, '2022-10-10', '15:00', 2, 1, 1, 2, 5);
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (2, '2022-11-12', '12:00', 1, 3, 1, 2, 3);
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (3, '2022-10-11', '19:00', 1, 2, 3, 2, 2);
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (4, '2022-10-13', '15:00', 1, 1, 4, 2, 2);
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (5, '2023-01-19', '05:00', 1, 5, 2, 2, 4);
INSERT INTO `LittleLemonDB`.`Bookings` (`idBookings`, `BookingDate`, `TimeSlot`, `NumberOfGuests`, `CustomerID`, `EmployeeID`, `BookingType`, `TableID`) VALUES (6, '2023-01-19', '08:00', 1, 6, 5, 2, 6);
